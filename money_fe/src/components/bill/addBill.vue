<template>
  <div>
    <a-card :bordered="false">
      <a-card-grid style="width:22%;height:100px;padding:10px;padding-top:15px;">
        <div style="float:left;width:50%;">
          <a-icon type="shopping" theme="filled" style="font-size:50px;color:red;" />
        </div>
        <div style="float:left;width:40%;text-align:right;">
          <a-statistic title="累计消费" :value="1128" style="">
          </a-statistic>
        </div>
      </a-card-grid>
      <a-card-grid style="width:22%;height:100px;;margin-left:4%;padding:10px;padding-top:15px;">
          <div style="float:left;width:50%;">
          <a-icon type="shopping" theme="filled" style="font-size:50px;color:red;" />
        </div>
        <div style="float:left;width:40%;text-align:right;">
    ...
    <div
      style="margin-top:50px;width:100%;height:500px;border:1px solid rgb(180,180,180)"
      id="echartss"
    ></div>
  </div>
</template>
